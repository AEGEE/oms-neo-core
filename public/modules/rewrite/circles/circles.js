(function ()
{
  ...
  function config($stateProvider)
  {
    ...
    .state('app.circles', {
      ...
      views   : {
        'pageContent@app': {
          templateUrl: baseUrl + 'modules/rewrite/circles/circles.html',
    ...
    .state('app.circles.single', {
      ...
      views   : {
        'pageContent@app': {
          templateUrl: baseUrl + 'modules/rewrite/circles/single_circle.html',
  ...
  function SimpleCircleDirective() {
    return {
      ...
      templateUrl: baseUrl + 'modules/rewrite/circles/directive_circle_simple.html'
    };
  }
  ...
  function CirclesController($http) {
    ...
    infiniteScroll($http, vm, baseUrl + 'api/circles', vm.injectParams);
  }
  ...
  function SingleCircleController($http, $stateParams) {
    ...
    vm.loadCircle = () => {
      $http({
        url: baseUrl + 'api/circles/' + $stateParams.id,
        method: 'GET'
      }).then((response) => {
    ...
    infiniteScroll($http, vm, baseUrl + 'api/circles/' + $stateParams.id + '/members', vm.injectParams);
    vm.loadCircle();
  } 
