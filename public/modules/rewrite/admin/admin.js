(function ()
{
        ...
        // State
         $stateProvider
            ...
            .state('app.admin.body_types', {
                ...
                views   : {
                    'pageContent@app': {
                        templateUrl: baseUrl + 'modules/rewrite/admin/body_admin.html',
            ...
            .state('app.admin.circles', {
                ...
                views   : {
                    'pageContent@app': {
                        templateUrl: baseUrl + 'modules/rewrite/admin/circle_admin.html',
    ...
    function CircleAdminController($http) {
        ...
        vm.formInclude = baseUrl + 'modules/rewrite/admin/edit_globalcircle_form.html';
    ...
    function BodyAdminController($http, $scope) {
        ...
        vm.formInclude = baseUrl + 'modules/rewrite/admin/edit_bodytype_form.html';
        ...
        vm.saveBodyType = function() {
            ...
            if(vm.edited_body_type.id) {
                request = {
                    method: 'PUT',
                    url: baseUrl + 'api/bodies/types/' + vm.edited_body_type.id,
